...
import { Upload, FileText, AlertCircle, CheckCircle, FileDown, Eye, Trash2, ImageIcon } from 'lucide-react';
...
const UploadCheck = () => {
  ...
  // Scroll to top on component mount (optional, but good for consistent user experience)
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
